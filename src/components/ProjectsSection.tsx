...
const projects = [
  ...
  {
    title: "YouTube Clone with Movie Recommendation",
    description: "YouTube-style video platform with intelligent movie recommendation logic, search functionality, and modern user interface.",
